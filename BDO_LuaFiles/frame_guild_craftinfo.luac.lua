...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\guild\frame_guild_craftinfo.luac 
...
control = {_frameDefaultBG = (UI.getChildControl)(Panel_Window_Guild, "Static_Frame_CraftInfoBG"), _scroll = (UI.getChildControl)(Panel_Guild_CraftInfo, "Scroll_CraftInfo"), _BG = (UI.getChildControl)(Panel_Guild_CraftInfo, "Static_FunctionBG"), workList = (UI.getChildControl)(Panel_Guild_CraftInfo, "StaticText_Parts_Title")}
, 
uiPool = {
exchange = {}
}
, 
config = {maxExchangeCount = 3, maxEnchantCount = 10, scroll_startIdx = 0, last_recipeArrayKey = 0, 
recipeArray = {}
}
}
...
guildCraftInfo.Init = function(self)
  -- function num : 0_0 , upvalues : newPanel
...
guildCraftInfo.exchangeSlotSet = function(self, exchange_Idx, isShow)
  -- function num : 0_1
  local exchangeSlot = ((self.uiPool).exchange)[exchange_Idx]
  ;
...
guildCraftInfo.Update = function(self)
  -- function num : 0_2 , upvalues : guildCraftInfo, UI_color
  for exchange_Idx = 0, (self.config).maxExchangeCount - 1 do
    local exchangeSlot = ((self.uiPool).exchange)[exchange_Idx]
...
Guild_CraftInfo_EnchantItemToolTip = function(isShow, enchantItemKeyRaw, exchangeUi_Idx, enchant_Idx)
  -- function num : 0_3 , upvalues : guildCraftInfo
...
Guild_CraftInfo_ScrollEvent = function(isScrollUp)
  -- function num : 0_4 , upvalues : guildCraftInfo
...
HandleClicked_Guild_CraftInfo_Scroll = function()
  -- function num : 0_5 , upvalues : guildCraftInfo
...
FGlobal_Guild_CraftInfo_Init = function()
  -- function num : 0_6 , upvalues : guildCraftInfo
  guildCraftInfo:Init()
end

FGlobal_Guild_CraftInfo_Open = function(isShow)
  -- function num : 0_7 , upvalues : newPanel, guildCraftInfo
  if isShow == true then
...
guildCraftInfo.registEventHandler = function(self)
  -- function num : 0_8 , upvalues : guildCraftInfo
